...
class OoxmlRulesTest {
    @Test fun desktopExcelWorksheetOrderIsAccepted() {
        OoxmlRules.requireValidWorksheet("<?xml version=\"1.0\"?><worksheet><sheetFormatPr/><cols></cols><sheetData></sheetData><autoFilter/><mergeCells/></worksheet>")
    }

    @Test(expected = IllegalArgumentException::class)
    fun mergeCellsBeforeAutoFilterIsRejectedForDesktopExcel() {
        OoxmlRules.requireValidWorksheet("<?xml version=\"1.0\"?><worksheet><sheetFormatPr/><cols></cols><sheetData></sheetData><mergeCells/><autoFilter/></worksheet>")
    }
