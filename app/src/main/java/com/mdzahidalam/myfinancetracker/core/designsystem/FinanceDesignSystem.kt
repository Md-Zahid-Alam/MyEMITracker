...
object FinanceDesignSystem {
    ...
    val DarkColors = darkColorScheme(
        primary = Color(0xFF7AE3DC), onPrimary = Color(0xFF002F2D),
        primaryContainer = Color(0xFF005B57), onPrimaryContainer = Color(0xFFD1FAF6),
        secondary = Color(0xFFBAD7D1), onSecondary = Color(0xFF142F2B),
        secondaryContainer = Color(0xFF304D48), onSecondaryContainer = Color(0xFFD4F0EA),
        ...
        background = Color(0xFF0A1110), surface = Color(0xFF151D1B),
        surfaceVariant = Color(0xFF293431), onSurfaceVariant = Color(0xFFC5D1CE),
        onBackground = Color(0xFFE5ECEA), onSurface = Color(0xFFE5ECEA),
        outline = Color(0xFF98A5A1), outlineVariant = Color(0xFF46524F),
